...
{
    public partial class FrmBolumler1 : Form
    {
        public FrmBolumler1()
        {
            InitializeComponent();
        ...
        private void FrmBolumler1_Load(object sender, EventArgs e)
        {
            // TODO: Bu kod satırı 'yurtkayitDataSet12.Bolumler' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.bolumlerTableAdapter.Fill(this.yurtkayitDataSet12.Bolumler);
